<?php
namespace Modules\CollegesManagement\Controllers;

use Modules\CollegesManagement\Models\CollegesModel;
...
class Colleges extends BaseController
{
    ...
    public function index($offset = 0)
    {
        ...
        $data['viewName'] = 'Modules\CollegesManagement\Views\colleges\index';
   ...
   public function show_college($id)
	{
        ...
        $data['viewName'] = 'Modules\CollegesManagement\Views\colleges\collegeDetails';
        echo view('App\Views\theme\index', $data);
	}
		...
		if(!empty($_POST))
		{
			if (!$this->validate('college'))
			{
				...
				$data['errors'] = \Config\Services::validation()->getErrors();
					...
					$data['viewName'] = 'Modules\CollegesManagement\Views\colleges\frmCollege';
					echo view('App\Views\theme\index', $data);
			}
			else
			{
